...
```{r, warning = F, message = F}
# Manually create a static version - don't re-run before knit
#customer_with_cluster_static <- tibble(customer_with_cluster)

customer_with_cluster_static <- customer_with_cluster_static %>% 
  #rename("cluster" = ".cluster") %>% 
  mutate(cluster_name = recode(cluster, "1"  = "High income, high spend",
                               "2" = "Mid income, mid spend",
                               "3" = "Lower income, low spend",
                               "4" = "Lower income, high spend",
                               "5" = "High income, low spend",))
