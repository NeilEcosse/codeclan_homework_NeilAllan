...
There are now proportionally more people in older age groups, who are more likely to develop cancer; estimates published by National Records of Scotland *(see reference section below)* anticipate that this trend will continue, so cancer services in The Borders will need to increase provision to treat and support these patients.
