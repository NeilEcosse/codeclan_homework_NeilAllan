...
although this type of join returns all records from both tables, it is not possible to have a fraud transaction which doesn't also appear inb a table of all transactions. Any extra rows would suggest an error in the fraud table.
```{r}
